...
def prepare_local_params(parser, ext_args=None):
    parser.add_argument("-model_name", required=False, type=str,
                        default="CL_dropout_encoder64_decoder_attn_regression_model101_gmm")
    ...
    parser.add_argument("-normalize_HW_per_family", required=False, action="store_true",
                        default=False)
    parser.add_argument('-e_chk', type=str, default="/home/ec2-user/nas-rec-engine/saved_models/gpi_acc_predictor_CL_dropout_encoder64_decoder_model_new_loss_seed109_best.pt", required=False)
...
def main(params):
    ...
    start = time.time()
    try:
        train_predictorV2(_batch_fwd_func, model, train_loader, perf_criterion, optimizer, book_keeper,
    ...
    with torch.no_grad():
        ...
        run_predictor_demoV2(_batch_fwd_func, model, test_loader,
